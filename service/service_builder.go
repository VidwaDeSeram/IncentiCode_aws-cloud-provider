...
//go:generate mockgen -destination ../mocks/service_config_loader.go -package mocks -mock_names ConfigLoader=ServiceConfigLoader github.com/VidwaDeSeram/IncentiCode_aws-cloud-provider/service ConfigLoader
